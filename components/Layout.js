...
export default function Layout({children}){
    return (
        <div className="font-sans bg-cyan-300 font-manrope font-light">
            ...
            <div className='w-full opacity-85 bg-cyan-100 flex flex-col items-center justify-around text-xl p-20'>
                {/* <h1 className='font-extrabold text-center text-4xl pb-6'>About Me</h1> */}
                    ...
                    <p className='md:w-3/5 text-black p-8 '>I'm a full-stack software engineer in Chicago with a background in music, writing, and teaching. I fell in love with coding because it gives me opportunities to solve difficult problems and be creative every day.</p>
